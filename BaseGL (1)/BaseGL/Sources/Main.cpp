...
struct Scene{
    ...
    void render() {
        ...
        // Set the lights in the shader :
        {
            ...
            shaderProgramPtr->set (std::string("lightSource.position"), light.m_position);
            shaderProgramPtr->set (std::string("lightSource.color"), light.m_color);
            shaderProgramPtr->set (std::string("lightSource.intensity"), light.m_intensity);
            shaderProgramPtr->set (std::string("lightSource.isActive"), 1);
        }
