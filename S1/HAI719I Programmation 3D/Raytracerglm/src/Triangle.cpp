...
Triangle::Triangle(glm::vec4 const & v0 , glm::vec4 const & v1 , glm::vec4 const & v2 )
{
    v[0] = v0;
    v[1] = v1;
    v[2] = v2;
...
Triangle::Triangle(glm::vec4 const & v0 , glm::vec4 const & v1 , glm::vec4 const & v2, Material *material)
{
    v[0] = v0;
    v[1] = v1;
    v[2] = v2;
...
Triangle::Triangle(glm::vec4 const & v0 , glm::vec4 const & v1 , glm::vec4 const & v2,Material *material, glm::vec4 normal)
{
    v[0] = v0;
    v[1] = v1;
    v[2] = v2;
...
void Triangle::setNormal(glm::vec4 normal)
{
    this->normal = normal;
}
...
{
    glm::vec4 v1 = glm::vec4( v[1] - v[0]);
    glm::vec4 v2 = glm::vec4( v[2] - v[0]);
    glm::vec4 nNotNormalized = glm::cross(v1,v2);
...
{
    glm::vec4 e1, e2 , h, s, q;
    float a,f,u,v,t;
    e1=this->v[1]-this->v[0];
    e2=this->v[2]-this->v[0];
    glm::vec4 orig = r.getPosition();
    glm::vec4 dir = r.getDirection();
    ...
    */
    ...
    if (t > t_min && t < t_max) // Intersection avec le rayon
    {
        ...
        glm::vec4 norm = vNormal[0]*u0 + vNormal[1]*u1+ vNormal[2]*u2;
