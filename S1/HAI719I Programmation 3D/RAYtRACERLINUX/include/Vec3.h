...
public:
    ...
    float dot( Vec3 const & b ) const {
       return mVals[0]*b[0] + mVals[1]*b[1] + mVals[2]*b[2];
    }
    ...
    Vec3 cross(Vec3 const & b ) const {
       return Vec3( mVals[1]*b[2] - mVals[2]*b[1] ,
                    mVals[2]*b[0] - mVals[0]*b[2] ,
                    mVals[0]*b[1] - mVals[1]*b[0] );
    }
