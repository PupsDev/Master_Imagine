...
{
        this->shaderId = load(vertPath, fragPath);
...
void Shader::setUniformMat4(const GLchar* name, mlm::mat4 matrix)
{
        glUniformMatrix4fv(glGetUniformLocation(shaderId, name),1, GL_FALSE,&matrix[0]); 
}
